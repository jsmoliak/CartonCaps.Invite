...
{
    public class ReferralsRepositoryTests
    {
        // Tests that the Add method correctly adds a Referral entity to the database.
        [Fact]
        public async Task Add_Should_Add_Entity()
        {
            ...
            var repository = new ReferralsRepository(dbContext);
            var referral = new Referral(referrer.UserId, referrer.ReferralCode.ReferralCodeId, 1);

            // Act
            repository.Add(referral);
            await repository.SaveChangesAsync(CancellationToken.None);

            var result = await repository.GetByIdAsync(referral.ReferralId, CancellationToken.None);

            // Assert
            Assert.Equivalent(referral, result);
        }

        // Tests that the AddAsync method correctly adds a Referral entity asynchronously to the database.
        [Fact]
        public async Task AddAsync_Should_Add_Entity()
        {
            ...
            // Act
            await repository.AddAsync(referral, CancellationToken.None);
            await repository.SaveChangesAsync(CancellationToken.None);
            var result = await repository.GetByIdAsync(referral.ReferralId, CancellationToken.None);
        ...
        // Tests that the GetByIdAsync method correctly retrieves a Referral entity by its ID.
        [Fact]
        ...
        // Tests that the GetAllAsync method correctly retrieves all Referral entities from the database.
        [Fact]
        public async Task GetAllAsync_Should_Get_Entities()
        {
            ...
            // Assert
            Assert.Equivalent(new[] { referral }, result);
        }

        // Tests that the FindAsync method correctly retrieves Referral entities based on a predicate.
        [Fact]
        ...
        // Tests that the FindFirstOrDefaultAsync method correctly retrieves the first Referral entity that matches a predicate.
        [Fact]
        public async Task FindFirstOrDefaultAsync_Should_Get_Entity()
        {
            ...
            // Act
            var result = await repository.FindFirstOrDefaultAsync(r => r.ReferralId == referral.ReferralId, CancellationToken.None);

            // Assert
            Assert.Equivalent(referral, result);
        }

        // Tests that the Update method correctly updates an existing Referral entity in the database.
        [Fact]
        ...
        // Tests that the Remove method correctly removes a Referral entity from the database.
        [Fact]
